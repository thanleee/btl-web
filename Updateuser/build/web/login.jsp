...
<head>
    ...
    <link rel="stylesheet" href="style-head-women.css">
...
<body>
    ...
    <!-- <section>
   	...
   	<div class="login" style="margin:181px 0 59px 0">
    <div class="container">
    <form action="login" method="post" >
        <div class="content hop1">
            <div class="header">
                <span class="text1">Đăng Nhập</span>
                <div class="delete">X</div>
            ...
            <div class="save-password">
                ...
                <span class="save-password__text">Lưu mật khẩu</span>
            </div>
            <div class="click-login">
                <button type="submit" class=" click-login__login ">Đăng nhập</button>
                <a href="" class="click-login__forget">Quên mật khẩu</a>
            </div>
            
        </div>
    </form>
        <div class="content hop2">
            <h2 class="quest">Bạn mới biết đến BB</h2>
            <button  class=" click-login__login" style="margin-top: 10px">
            	<a href="dangki.jsp" style="text-decoration: none ; color:#fff ; font-size: 0.9rem">Đăng kí</a>
            </button>
        </div>
