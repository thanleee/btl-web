<%-- 
    Document   : cart_header_women
    Created on : May 9, 2023, 10:41:32 PM
    Author     : DELL
--%>
                        ...
                        <div id="containerlogin" class="containerlogin">
                            <div class="container-log">
                                ...
                                <div class="content hop2">
                                    ...
                                    <button class=" click-login__login"><a
                                            href="sign-up_header-women.jsp">REGISTER</a></button>
                                </div>
                                <div class="img-log"
                                ...
                                <div class="viewcart">
                                    ...
                                    <div class="viewcart__sale">
                                        ...
                                        <div class="btn__viewcart flex ">
                                            <div class="btn__1">
                                                <button class="btn btn--1"><a href="./cart_header_women.jsp">VIEW
                                                        CART</a></button>
                                            </div>
                                            <div class="btn__2">
                    ...
                    <div class="body__cart--1">
                        <div class="body__cart-box1">
                            ...
                            <div class="body__cart-box1-pri">
                                ...
                                <div class="body__cart-box1-pri__content">
                                    <div class="body__cart-box1-pri__content-name">
                                        <div class="body__cart-box1-pri__content-text">
                                            <a href="" class="body__cart-box1-pri__content-name__text">MAN ACTIVE COLOUR
                                                BLOCK PERFORMANCE VEST</a>
                                        </div>
                                        <div class="body__cart-box1-pri__content-delete">
                                            <a href="" class="delete" alt="Remove">
                                                X
                                    ...
                                    <div class="body__cart-box1-pri__content-source">
                                        <span class="body__cart-box1-pri__content-source--text ">Shipped from the
                                            UK</span>
                                    </div>
                                    <div class="body__cart-box1-pri__content-info">
                                        <div class="body__cart-box1-pri__content-info__size">
                        ...
                        <div class="body__cart-box2">
                            <div class="body__cart-box2__img">
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRdNicDDVQ_TelRzqG1c28sPTmQvrV8aZkQVQWqPKH5QS7M6rrMKCL2guqBxhMqqQ0AjIc&usqp=CAU"
                                    alt="" class="box2__img">
                            </div>
                            <div class="body__cart-box2__img">
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTZF8BqZhhhWgeFgIIbIqMPjnVaCPgbHIjnDsxhET2HoyrmNce3tOF8pSs60-clLlxFi4U&usqp=CAU"
                                    alt="" class="box2__img">

                            </div>
                            <div class="body__cart-box2__img">
                                <img src="https://www.artisantg.com/assets/icons/Secure_PMT_319x250.png" alt=""
                                    class="box2__img">
                    ...
                    <div class="body__cart--2">
                        <div class="body__cart-box3">
                            ...
                            <div class="body__cart-box3__pay">
                                ...
                                <div class="body__cart-box3__pay-text2  ">OR, Checkout with</div>
                                <a href="" class="body__cart-box3__pay-bank box3--row">
                                    <img src="https://cdn0.iconfinder.com/data/icons/shift-ecommerce/32/Paypal-512.png"
                                        alt="" class="pay-bank__img">
                                    <img src="https://icon-library.com/images/paypal-icon-vector/paypal-icon-vector-4.jpg"
                                        alt="" class="pay-bank__img">
                                </a>
                        ...
                        <div class="body__cart-box4">
                            <div class="body__cart-box4__pay-bank">
                                <span class="body__cart-box4__pay-bank-info">
                                 ...
                                 -->
                                    <div class="box4__pay-bank__img"
                                        style="background-image: url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR5jmUkWb_h4gTSWpAwPYmIpCe77uHc7pK2zup_0VSxtNA00Qn8XDLEDM8Vdy83mhOgvw&usqp=CAU); ">
                                    </div>
                                </span>
                                <span class="body__cart-box4__pay-bank-text">Pay $5.50 in 4 installments every 2
                                    weeks</span>
                            ...
                            <div class="body__cart-box4__pay-bank">
                                <span class="body__cart-box4__pay-bank-info">
                                    <img src="https://cdn0.iconfinder.com/data/icons/shift-ecommerce/32/Paypal-512.png"
                                        alt="" class="box4__pay-bank__img">
                                    <!-- <img src="https://icon-library.com/images/paypal-icon-vector/paypal-icon-vector-4.jpg" alt="" class="box4__pay-bank__img"> -->
                                </span>
                                <span class="body__cart-box4__pay-bank-text">Pay in 4 interest-free payments on eligible
                                    purchases.
                            ...
                            <div class="body__cart-box4__pay-bank">
                                ...
                                <span class="body__cart-box4__pay-bank-text">Pay In 30 days or $5.50 in 4 installments
                                    every 2 weeks </span>
                            </div>
                        </div>
                    </div>
